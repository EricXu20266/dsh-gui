/**
 * dsh-discovery browser client bundle, mirroring the DHS client preset for an
 ...
 * the injected require. All styles are inline — no CSS-module pipeline needed.
 */
import { defineConfig } from 'tsdown'

const id = 'dsh-discovery'
